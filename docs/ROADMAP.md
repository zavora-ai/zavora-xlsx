...
| `serde` integration (Phase 10.1) | ✅ |
| `#[derive(ExcelRow)]` proc macro (Phase 10.2) | ✅ |
| CSV / TSV export (Phase 7.5) | ✅ |
| Node.js bindings via napi-rs (Phase 10.6) | ✅ |
| CLI tool — inspect, export, convert (Phase 10.8) | ✅ |
...
| 10.5 | Python bindings (PyO3) | `pip install zavora-xlsx` | 📋 Requirements spec complete |
...
2. **Phase 10.5 (Python bindings)** — Requirements spec is ready, implementation is next
