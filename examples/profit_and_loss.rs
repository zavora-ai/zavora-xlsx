...
fn main() -> Result<()> {
    ...
    ws.write_with_format(
        r,
        1,
        "Fiscal Year 2025  |  All amounts in USD  |  Formulas auto-calculate",
        &sub,
    )?;
    r += 1;
    for c in 1..=14u16 {
    ...
    for c in 2..=14u16 {
        ws.write_with_format(r, c, "", &section_val(green))?;
    }
    ...
    let revenue_items: Vec<(&str, [f64; 12])> = vec![
        (
            "Product Sales",
            [
                85000.0, 92000.0, 88000.0, 95000.0, 102000.0, 98000.0, 105000.0, 110000.0,
                108000.0, 115000.0, 120000.0, 135000.0,
            ],
        ),
        (
            "Service Revenue",
            [
                42000.0, 45000.0, 43000.0, 48000.0, 50000.0, 52000.0, 55000.0, 53000.0, 56000.0,
                58000.0, 60000.0, 65000.0,
            ],
        ),
        (
            "Subscription Fees",
            [
                18000.0, 18500.0, 19000.0, 19500.0, 20000.0, 20500.0, 21000.0, 21500.0, 22000.0,
                22500.0, 23000.0, 24000.0,
            ],
        ),
        (
            "Consulting",
            [
                12000.0, 8000.0, 15000.0, 10000.0, 13000.0, 11000.0, 14000.0, 9000.0, 16000.0,
                12000.0, 10000.0, 18000.0,
            ],
        ),
        (
            "Other Income",
            [
                3000.0, 2500.0, 4000.0, 3500.0, 2000.0, 5000.0, 3000.0, 4500.0, 2500.0, 3000.0,
                6000.0, 4000.0,
            ],
        ),
    ];
    ...
    for (i, (name, vals)) in revenue_items.iter().enumerate() {
        ...
        for (c, v) in vals.iter().enumerate() {
            ws.write_with_format(r, (c + 2) as u16, *v, vf)?;
        }
        // Total = SUM(C:N)
    ...
    for c in 2..=14u16 {
        ws.write_formula(
            r,
            c,
            &format!("SUM({}{}:{}{})", col(c), rev_start + 1, col(c), rev_end + 1),
        )?;
    ...
    for c in 2..=14u16 {
        ws.write_with_format(r, c, "", &section_val(red))?;
    }
    ws.set_row_height(r, 24.0)?;
    r += 1;
    ...
    let cogs_items: Vec<(&str, [f64; 12])> = vec![
        (
            "Materials & Supplies",
            [
                28000.0, 30000.0, 29000.0, 31000.0, 33000.0, 32000.0, 34000.0, 36000.0, 35000.0,
                37000.0, 39000.0, 42000.0,
            ],
        ),
        (
            "Direct Labor",
            [
                22000.0, 22000.0, 23000.0, 23000.0, 24000.0, 24000.0, 25000.0, 25000.0, 26000.0,
                26000.0, 27000.0, 28000.0,
            ],
        ),
        (
            "Manufacturing OH",
            [
                8000.0, 8000.0, 8500.0, 8500.0, 9000.0, 9000.0, 9500.0, 9500.0, 10000.0, 10000.0,
                10500.0, 11000.0,
            ],
        ),
        (
            "Shipping & Freight",
            [
                4500.0, 5000.0, 4800.0, 5200.0, 5500.0, 5300.0, 5800.0, 6000.0, 5700.0, 6200.0,
                6500.0, 7000.0,
            ],
        ),
    ];
    ...
    for c in 2..=14u16 {
        ws.write_with_format(r, c, "", &section_val("#E67E22"))?;
    }
    ws.set_row_height(r, 24.0)?;
    r += 1;
    ...
    let opex_items: Vec<(&str, [f64; 12])> = vec![
        (
            "Salaries & Wages",
            [
                35000.0, 35000.0, 35000.0, 36000.0, 36000.0, 36000.0, 37000.0, 37000.0, 37000.0,
                38000.0, 38000.0, 40000.0,
            ],
        ),
        (
            "Rent & Utilities",
            [
                8000.0, 8000.0, 8000.0, 8000.0, 8500.0, 8500.0, 8500.0, 8500.0, 9000.0, 9000.0,
                9000.0, 9000.0,
            ],
        ),
        (
            "Marketing & Ads",
            [
                12000.0, 15000.0, 10000.0, 18000.0, 14000.0, 16000.0, 20000.0, 13000.0, 17000.0,
                15000.0, 22000.0, 25000.0,
            ],
        ),
        (
            "Software & Tech",
            [
                5000.0, 5000.0, 5500.0, 5500.0, 6000.0, 6000.0, 6500.0, 6500.0, 7000.0, 7000.0,
                7500.0, 8000.0,
            ],
        ),
        (
            "Insurance",
            [
                3000.0, 3000.0, 3000.0, 3000.0, 3000.0, 3000.0, 3200.0, 3200.0, 3200.0, 3200.0,
                3200.0, 3200.0,
            ],
        ),
        (
            "Professional Fees",
            [
                4000.0, 2000.0, 5000.0, 3000.0, 4500.0, 2500.0, 6000.0, 3500.0, 4000.0, 2000.0,
                5500.0, 8000.0,
            ],
        ),
        (
            "Travel & Meals",
            [
                3000.0, 2500.0, 4000.0, 3500.0, 5000.0, 4000.0, 3000.0, 6000.0, 4500.0, 3000.0,
                5000.0, 7000.0,
            ],
        ),
        (
        ...
        (
            "Other Expenses",
            [
                1500.0, 2000.0, 1000.0, 2500.0, 1800.0, 1200.0, 3000.0, 1500.0, 2000.0, 1000.0,
                2500.0, 3500.0,
            ],
        ),
    ];
    ...
    for c in 2..=14u16 {
        ws.write_formula(
            r,
            c,
            &format!("{}{}-{}{}", col(c), gp_row + 1, col(c), total_opex_row + 1),
        )?;
